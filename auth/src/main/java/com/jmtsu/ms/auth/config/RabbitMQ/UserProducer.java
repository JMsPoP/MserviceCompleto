package com.jmtsu.ms.auth.config.RabbitMQ;


import com.jmtsu.ms.auth.dto.EmailDTO;
...
public class UserProducer {
    ...
    public void publishMessageEmail(UserModel userModel) {
        ...
        htmlContent = htmlContent.replace("[[NAME]]", userModel.getName());

        String verifyURL = this.verifyURL + userModel.getVerificationCode();
